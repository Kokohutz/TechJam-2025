...
if __name__ == '__main__':
    print("Starting Lynx Chat API (FastAPI version)...")
    print(f"Demo users available: {', '.join(demo_users)}")
    print("Available endpoints:")
    print("  POST /users/register - Register new user")
    print("  GET  /users/profile/<username> - Get user profile")
    print("  GET  /users/search?q=<query>&current_user=<username> - Search users")
    print("  GET  /chats/<username> - Get user's chats")
    print("  POST /chats/create - Create new chat")
    print("  GET  /chats/<chat_id>/messages - Get messages")
    print("  POST /chats/<chat_id>/messages - Send message")
    print("  GET  /chats/<chat_id>/messages/since/<timestamp> - Get new messages (polling)")
    print("  GET  /admin/users - List all users (testing)")
    print("  POST /admin/reset - Reset all data (testing)")
    print("\nServer running on http://localhost:8002")
    print("Access interactive API docs at http://localhost:8002/docs")
